...
export function getElementBorderClass(element?: string): string {
  switch (element) {
    case 'Aero':
    case '기류':
      return 'border-emerald-400/60 shadow-[0_0_10px_rgba(52,211,153,0.12)]'
    case 'Fusion':
    case '용융':
      return 'border-red-400/60 shadow-[0_0_10px_rgba(248,113,113,0.12)]'
    case 'Electro':
    case '전도':
      return 'border-purple-400/60 shadow-[0_0_10px_rgba(192,132,252,0.12)]'
    case 'Glacio':
    case '응결':
      return 'border-cyan-400/60 shadow-[0_0_10px_rgba(56,189,248,0.12)]'
    case 'Spectro':
    case '회절':
      return 'border-amber-300/60 shadow-[0_0_10px_rgba(253,224,71,0.12)]'
    case 'Havoc':
    case '인멸':
      return 'border-pink-400/60 shadow-[0_0_10px_rgba(244,114,182,0.12)]'
    default:
...
const SLOT_BOX_CLASS = (isOver: boolean, char: Character | null) => {
  if (char) {
    return `w-14 h-14 sm:w-20 sm:h-20 lg:w-[100px] lg:h-[100px] xl:w-[110px] xl:h-[110px] aspect-square rounded-lg sm:rounded-2xl flex flex-col items-center justify-center p-0.5 sm:p-1 md:p-1.5 relative group transition-all duration-300 border-2 ${getElementBorderClass(char.element)}`
  }
