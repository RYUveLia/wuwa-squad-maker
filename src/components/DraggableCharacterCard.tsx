...
const NAME_CLASS = 'mt-1 sm:mt-2 text-[11px] sm:text-sm md:text-base font-bold text-slate-300 group-hover:text-slate-100 transition-colors truncate w-full text-center'
