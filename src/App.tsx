...
const LAYOUT_STYLES = {
  ...
  splitGrid: 'w-full max-w-7xl flex flex-col md:flex-row gap-6 items-stretch flex-1',
  leftColumn: 'w-full md:w-[43%] bg-slate-900/30 border border-slate-800/40 rounded-2xl p-4 md:p-5 backdrop-blur-sm shadow-xl flex flex-col max-h-none md:max-h-[76vh] md:overflow-hidden',
  rightColumn: 'w-full md:w-[57%] flex flex-col gap-4 max-h-none md:max-h-[76vh] md:overflow-hidden'
}
...
const SQUAD_LIST_STYLES = {
  ...
  scroller: 'flex flex-col gap-4 overflow-y-visible md:overflow-y-auto pr-1 flex-1 scrollbar-thin scrollbar-thumb-slate-800 scrollbar-track-transparent p-1',
